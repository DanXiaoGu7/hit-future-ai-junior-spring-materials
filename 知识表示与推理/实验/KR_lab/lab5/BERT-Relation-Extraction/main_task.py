...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_data", type=str, default='./\data\SemEval2010_task8_all_data\SemEval2010_task8_all_data\SemEval2010_task8_training\TRAIN_FILE.TXT', \
                        help="training data .txt file path")
    parser.add_argument("--test_data", type=str, default='./\data\SemEval2010_task8_all_data\SemEval2010_task8_all_data\SemEval2010_task8_testing_keys\TEST_FILE_FULL.TXT', \
    ...
    parser.add_argument("--entity_representation", type=str, default='entity_start',
                        choices=['entity_start', 'cls'],
                        help="relation representation: entity_start for ENTITY MARKERS+ENTITY START, cls for ENTITY MARKERS+[CLS]")
    ...
    if args.task == 'fewrel':
        from src.tasks.infer import FewRel
